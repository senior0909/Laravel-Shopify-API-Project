...
<head>
    <meta charset="UTF-8">
    <title>Image Magnifier | Josh Admin Template</title>
            ...
            <section class="sidebar ">
                <div class="page-sidebar  sidebar-nav">
                    ...
                    <ul class="page-sidebar-menu" id="menu">
                        ...
                        <li>
                            <a href="tasks.html" class="redborder">
                                <i class="livicon" data-c="#42AACA" data-hc="#42AACA" data-name="list-ul" data-size="18" data-loop="true"></i>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-3 col-xs-6">
                                        <div class="mag img-responsive">
                                            <br />
                                            <img data-toggle="magnify" class="mag-style" src="img/img_holder/small/small_1.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-xs-6">
                                        <div class="mag img-responsive">
                                            <br />
                                            <img data-toggle="magnify" src="img/img_holder/small/small_5.jpg" alt="" class="mag-style">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-xs-6">
                                        <div class="mag img-responsive">
                                            <br />
                                            <img data-toggle="magnify" src="img/img_holder/small/small_4.jpg" alt="" class="mag-style img-responsive">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-xs-6">
                                        <div class="mag img-responsive">
                                            <br />
                                            <img data-toggle="magnify" src="img/img_holder/small/small_6.jpg" alt="" class="mag-style img-responsive">
                                        </div>
                                    </div>
                                </div>
                                <!--row-->
                                <div class="row" style="margin-top:40px;">
                                    ...
                                    <div class="col-md-3 col-xs-6">
                                        <div class="mag img-responsive">
                                            <br />
                                            <img data-toggle="magnify" src="img/img_holder/small/small_3.jpg" alt="" class="mag-style img-responsive">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-xs-6">
                                        <div class="mag img-responsive">
                                            <br />
                                            <img data-toggle="magnify" src="img/img_holder/small/small_2.jpg" alt="" class="mag-style img-responsive">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-xs-6">
                                        <div class="mag img-responsive">
                                            <br />
                                            <img data-toggle="magnify" src="img/img_holder/small/small_1.jpg" alt="" class="mag-style img-responsive">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-xs-6">
                                        <div class="mag img-responsive">
                                            <br />
                                            <img data-toggle="magnify" src="img/img_holder/small/small_5.jpg" alt="" class="mag-style img-responsive">
                                        </div>
                                    </div>
                                </div>
                                <div class="row" style="margin-top:40px;">

...
<head>
    <meta charset="UTF-8">
    <title>Blog Details | Josh Admin Template</title>
            ...
            <section class="sidebar ">
                <div class="page-sidebar  sidebar-nav">
                    ...
                    <ul class="page-sidebar-menu" id="menu">
                        <li>
                            <a href="index.html" class="blueborder">
                        ...
                        <li>
                            <a href="calendar.html" class="warningborder">
                        ...
                        <li>
                            <a href="tasks.html" class="dangerborder">

...
$('.message-type-box').on('keydown', function(event) {
    if(event.key === 'Enter') {
        ...
        $messageHtml = '<li class="odd mt-4"> <div class="chat-content pl-3 d-inline-block text-right"> <div class="box mb-2 d-inline-block text-dark message font-weight-medium fs-3 bg-light-inverse">' + chatMessageValue + '<br> </div></div><div class="chat-time d-inline-block text-end fs-2 font-weight-medium">' +  time +'</div> </li>';

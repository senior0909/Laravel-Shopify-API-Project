$(function () {
    ...
    var chart_area_basic = new ApexCharts(document.querySelector("#chart-area-basic"), options_area);
    ...
    var chart_area_spline = new ApexCharts(document.querySelector("#chart-area-spline"), options_spline);

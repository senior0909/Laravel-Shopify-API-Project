...
<body class="skin-josh">
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            ?>
                <form class="form-horizontal" action="/setDelivered" method="POST" enctype="multipart/form-data" style="padding-right: 2.2em">
                    <fieldset>     
                        <input type="hidden" name="_token" value="{{{ csrf_token() }}}"/>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="name">配送会社</label>
                            <div class="col-md-2">
                                <select class="form-control" name="tracking_company">
                                    <option value="ヤマト運輸">ヤマト運輸</option>
                                    <option value="佐川急便">佐川急便</option>
                                </select>
                            </div>
                            <label class="col-md-2 control-label" for="name">配送データのアップロード</label>
                            <div class="col-md-4">
                                <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                    ...
                                    <a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">削除</a>
                                </div>
                            </div>

                            <div class="col-md-1 text-right">
                                <button type="submit" class="btn btn-responsive btn-primary btn-sm">アップロード</button>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-primary ">
                        ...
                        <div class="panel-body">
                            <div class="row" style="margin-bottom: 15px;">                                
                                ...
                                <div class="col-lg-11">
                                    <form class="form-horizontal" action="/producers" method="get" enctype="multipart/form-data">
                                        <fieldset>                       
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <select id="e2" class="form-control select2 orderStatis" name="orderMonth">
        ...
        $(".csv_downloader").click(function(){
            ...
            $('input[type="checkbox"]', allPages).each(function(){
                if($(this).is(':checked')){
                    ...
                    var customer_id = $(this).parent('td').next('td').next('td').next('td').text();
                    if(table_company == '佐川急便') customer_id = $(this).parent('td').next('td').next('td').next('td').next('td').text();

                    if(delivery_status == "配送可能"){
                        delivery_list.push({'customer_id':customer_id,'delivery_status':'配送準備中'});
                        $(this).parent('td').next('td').html('<span class="button button-pill button-flat-highlight" style="width:130px;">配送準備中</span>');
                    }

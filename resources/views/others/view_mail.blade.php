...
<head>
    <meta charset="UTF-8">
    <title>View Mail | Josh Admin Template</title>
                                            ...
                                            <div class="row">
                                                <div class="nopadmar">
                                                    <div class="col-xs-4 no-padding col-md-3 col-lg-2">
                                                        <a href="reply.html" class="btn btn-sm btn-primary">
                                                            <span class="livicon" data-n="redo" data-s="12" data-c="white" data-hc="white"></span>
                                                            &nbsp;&nbsp;Reply
                                                        </a>
                                                    </div>
                                                    <div class="col-xs-4 no-padding col-md-3 col-lg-2">
                                                        <a href="forward.html" class="btn btn-sm btn-success">

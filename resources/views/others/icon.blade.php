...
<head>
    <meta charset="UTF-8">
    <title>Icons | Josh Admin Template</title>
...
<script src="js/josh.js" type="text/javascript" type="text/javascript"></script>
<script src="js/metisMenu.js" type="text/javascript" type="text/javascript"></script>

...
<head>
    <meta charset="UTF-8">
    <title>Animation Charts | Josh Admin Template</title>
...
<body class="skin-josh">
    ...
    <script src="vendors/animationcharts/jquery.flot.min.js" type="text/javascript"></script>
    <script src="vendors/animationcharts/jquery.flot.animator.min.js" type="text/javascript"></script>
    <script src="vendors/charts/circliful/jquery.circliful.min.js"></script>
    <script src="vendors/charts/jquery.flot.resize.js" language="javascript" type="text/javascript" ></script>
    <script src="js/pages/animation-chart.js"></script>
